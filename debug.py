...
for i, test_case in enumerate(os.listdir(resource_folder), 1):
    target = f"wuwa_inventory_system_{i}.png"
    ...
    for i, box in enumerate(sorted_boxes):
        ...
        cv2.imwrite(f'{attempt_folder}/21_cropped_icon_{i}.png', resized_item)
